...
import br.well.tembici.ui.pullrequest.view.PullRequestView
...
class ViewFactory(private val layoutInflater: LayoutInflater) {
    ...
    fun providePullRequestView(parent: ViewGroup?): PullRequestViewContract = PullRequestView(layoutInflater, parent)
}
